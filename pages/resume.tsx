      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <Glass style={{ width: '100%', maxWidth: '650px', margin: '0 auto' }}>
              <div style={{ padding: '25px 35px', lineHeight: '1.4', fontSize: '13px' }}>
                  {/* Header */}
                  <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                    <h2 style={{ fontSize: '1.6em', margin: '0 0 6px 0', color: '#c7d7ee', fontWeight: '600' }}>Danny Lin</h2>
                    <p style={{ margin: '0', color: '#b5c5d8', fontSize: '13px', fontWeight: '400' }}>
                  ...
                  <div style={{ marginBottom: '15px' }}>
                    <h3 style={{ color: '#c7d7ee', borderBottom: '2px solid #c7d7ee', paddingBottom: '4px', marginBottom: '10px', fontSize: '1.1em', fontWeight: '600', letterSpacing: '0.5px' }}>EDUCATION</h3>
                      <div style={{ marginBottom: '12px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3px' }}>
                          <strong style={{ fontSize: '1em', fontWeight: '600', color: '#c7d7ee' }}>University of Pennsylvania</strong>
                          <span style={{ fontSize: '0.9em', color: '#b5c5d8', fontWeight: '400' }}>Expected Graduation: December 2025</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3px' }}>
                          <em style={{ fontSize: '0.95em', color: '#c7d7ee' }}>Master of Science in Computer Science</em>
                          <span style={{ fontSize: '0.9em', color: '#b5c5d8' }}>Philadelphia, Pennsylvania</span>
                        </div>
                        <div style={{ textAlign: 'right', fontSize: '0.9em', color: '#b5c5d8', fontWeight: '400' }}>GPA: 4.0/4.00</div>
                      </div>
                  ...
                  {/* Skills */}
                  <div style={{ marginBottom: '15px' }}>
                    <h3 style={{ color: '#c7d7ee', borderBottom: '2px solid #c7d7ee', paddingBottom: '4px', marginBottom: '10px', fontSize: '1.1em', fontWeight: '600', letterSpacing: '0.5px' }}>SKILLS</h3>
                    <div style={{ marginBottom: '6px', fontSize: '13px', color: '#c7d7ee' }}><strong style={{ fontSize: '13px' }}>Technologies:</strong> Python, PySpark, Java, C, C++, SQL, R, HTML, CSS, JavaScript, React, SAS, and Swift</div>
                    <div style={{ marginBottom: '6px', fontSize: '13px', color: '#c7d7ee' }}><strong style={{ fontSize: '13px' }}>Languages:</strong> English (Native), Fuzhou Dialect (Native), and Mandarin (Fluent)</div>
                    <div style={{ fontSize: '13px', color: '#c7d7ee' }}><strong style={{ fontSize: '13px' }}>Interests:</strong> Basketball, Running, Pickleball, Investing, Real Estate, Artificial Intelligence, Software Development, and Data Science</div>
                  </div>

                  {/* Professional Experience */}
                  <div style={{ marginBottom: '15px' }}>
                    <h3 style={{ color: '#c7d7ee', borderBottom: '2px solid #c7d7ee', paddingBottom: '4px', marginBottom: '10px', fontSize: '1.1em', fontWeight: '600', letterSpacing: '0.5px' }}>PROFESSIONAL EXPERIENCE</h3>
                    
                    <div style={{ marginBottom: '12px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2px' }}>
                        <strong style={{ fontSize: '0.95em', color: '#c7d7ee' }}>AT&T - Software Engineer Internship</strong>
                        <span style={{ fontSize: '0.85em', color: '#b5c5d8' }}>Middletown, NJ | June 2024 – August 2024</span>
                      </div>
                      <div style={{ marginBottom: '4px', fontSize: '0.85em', color: '#c7d7ee' }}><em>Tools: Python, React, HTML, CSS, and Pandas</em></div>
                      <ul style={{ marginTop: '4px', paddingLeft: '14px', fontSize: '12px', color: '#c7d7ee' }}>
                    ...
                    <div style={{ marginBottom: '25px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '5px' }}>
                        <strong style={{ fontSize: '1.1em', color: '#c7d7ee' }}>Milliman - Data Analyst</strong>
                        <span style={{ fontSize: '0.95em', color: '#b5c5d8' }}>Brookfield, CT | June 2022 – June 2023</span>
                      </div>
                      <div style={{ marginBottom: '10px', color: '#c7d7ee' }}><em>Tools: Python, SQL, PySpark, SAS, and VBA</em></div>
                      <ul style={{ marginTop: '10px', paddingLeft: '20px', color: '#c7d7ee' }}>
                        <li style={{ marginBottom: '8px' }}>Automated downloading files from SFAS for client production by using Python, resulted in a 35% reduction in the time</li>
                        <li style={{ marginBottom: '8px' }}>Analyzed the client's database using Spark, coding a seamless pipeline database for optimal operation of parquet files</li>
                        <li style={{ marginBottom: '8px' }}>Streamlined the generation of monthly User Statistic Reports by 80% and eliminated errors by leveraging VBA and Excel</li>
